# -*- coding: utf-8 
# it is modified from yihong0618's code
# *-
import argparse
import os
import re
...
It is generated by [yihong0618](https://github.com/yihong0618/gitblog)
...
def _make_friend_table_string(s):
    ...
    try:
        ...
        return FRIENDS_TABLE_TEMPLATE.format(
            name=info_dict["name"], link=info_dict["link"], desc=info_dict["Desc"]
        )
